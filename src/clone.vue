...
<!-- first section -->
  ...
  <article class="bg-blue overflow-x-clip min-h-screen bg-cover bg-center text-white relative" >  
      ...
      <main class="flex flex-wrap justify-between items-center ml-4 md:ml-64 pt-20">

      <div class="flex ml-2 md:ml-12">
        <img src="/public/r-icon.png" alt="icon" class="w-10 h-10 md:w-14 md:h-14" />
        <h1 class="text-xl md:text-[40px] font-bold ml-2  ">RetailPay</h1>
      </div>

      


        <nav class="flex flex-wrap items-center justify-center space-x-4 md:space-x-20 mr-4 md:mr-52 relative">
          <ul class="flex flex-wrap space-x-2 md:space-x-7 text-sm md:text-[17px] font-medium mb-2 ">
            ...
            <li class="relative group cursor-pointer">
              ...
              <ul class=" p-2 absolute hidden group-hover:block group-hover:border-b-2 group-hover:border-l-2 group-hover:mb-20 ">
                <li><a href="home" class="block text-base md:text-xl  hover:text-purple-400"> Inventory Management</a></li>
                <li><a href="home" class="block text-base md:text-xl  hover:text-purple-400">Sales & Billing</a></li>
              </ul>
            </li>
            ...
            <li class="relative group cursor-pointer">
              ...
              <ul class="absolute hidden p-2 group-hover:block group-hover:border-b-2 group-hover:border-l-2">
                <li><a href="home" class="block text-base md:text-xl  hover:text-purple-400">FAQS</a></li>
                <li><a href="home" class="block text-base md:text-xl  hover:text-purple-400">Customer Stories</a></li>
              </ul>
            </li>
        ...
        <button class="bg-custom-blue-3 rounded-b-3xl rounded-t-3xl px-4 md:px-8 py-2 md:py-3 hover:bg-purple-400 text-sm md:text-base">
          Book a Demo
        </button>

        <img src="/public/line2.png" alt="" class="w-0 md:w-auto h-12 ">

        <img src="/public/message-icon.png" alt="" class="w-8 h-8 cursor-pointer">
        </nav>
    ...
    <div class="text-center text-4xl md:text-[80px] leading-[1.1] mt-20 font-bold tracking-tight px-4 md:px-0">
      <p> Forging the Future <br/> of Retail, Wholesale & <br/> Distribution. </p>
    </div>

    <p class="text-center mt-10 md:mt-[40px] text-lg md:text-2xl leading-[1.2] px-4 md:px-0">RetailPay provides a digital end-to-end platform that connects all members<br/> of the supply chain ecosystem for maximum value</p>
    <button class="relative bg-custom-blue-3 mx-auto md:ml-[44%] mt-14 py-3 md:py-5 rounded-full px-8 md:px-16 text-base md:text-[20px] font-bold hover:bg-purple-400 block">
      Get Started
    </button>

    <section class="border mx-4 md:mx-[10%] flex flex-wrap md:flex-nowrap items-center justify-between mt-28 rounded-t-3xl md:mr-48 md:ml-48 backdrop-blur-sm bg-blue-2 bg-cover bg-center border-white/80">
      <div class=" text-white text-xl md:text-[41px] leading-[1.3] tracking-tight relative font-light md:absolute md:left-[170px] w-full md:w-auto mb-8 md:mb-0">
        <p>
      ...
      <div class=" flex justify-center items-center relative w-full md:w-auto">
        <!-- <div class="absolute bg-yellow-300 blur-[60px] z-0 opacity-80  w-full h-full rounded-full top-[80px]"></div> -->
        <img src="/src/assets/lady-in-yellow.png" alt="woman_smiling" class="w-full max-w-[800px] h-auto object-contain z-10 md:ml-[650px]" />
      </div>
    </section>
...
<!-- Second section -->
  ...
  <article>
    ...
    <div class="border-2 shadow-lg flex flex-wrap justify-center items-center space-x-8 md:space-x-44 rounded-b-3xl p-4 md:p-8 mx-4 md:mx-48">
      <p class="text-center w-1/3 md:w-auto">
        <span class="md:text-4xl md:text-[83px] font-bold text-custom-blue-2 md:tracking-tighter">100K+</span><br/>
        <code class="text-custom-blue-2 text-base md:text-[25px] tracking-tight md:ml-16">Clients</code>
      </p>
      <p class="text-center w-1/3 md:w-auto">
        <span class="text-4xl md:text-[83px] font-bold text-custom-blue-2 tracking-tighter">40M + USD</span><br/>
        <code class="text-custom-blue-2 text-base md:text-[25px] tracking-tight md:ml-16">Turnover per month</code>
      </p>
      <p class="text-center w-1/3 md:w-auto">
        <span class="text-4xl md:text-[83px] font-bold text-custom-blue-2 tracking-tighter">15+</span><br/>
        <code class="text-custom-blue-2 text-base md:text-[25px] tracking-tight md:ml-4">Counties</code>
      </p>
    </div>

    <div class="flex flex-wrap justify-center items-center space-x-40 leading-[60px] p-32 mr-">
...
<!-- <div class="flex flex-wrap justify-center items-center space-x-8 md:space-x-40 leading-[1.2] p-8 md:p-32 mx-4 md:mx-0">
      <p class="text-2xl md:text-[60px] tracking-tight leading-[70px] font-bold md:mr-32 w-full md:w-auto text-center md:text-left">
        Why is RetailPay the<br/>very best tool for you.
      </p>

      <p class="text-lg md:text-3xl tracking-[1px] leading-[1.2] w-full md:w-auto text-center md:text-left">
        The RetailPay <strong>Bizwiz</strong> Suite<br/> comprises of multiple software<br/> organs that assist businesses in<br/> their day-to-day functions.
      </p>
    </div> -->

    <div class="flex flex-wrap justify-center items-center text-white space-x-4 md:space-x-12 mx-4 md:mx-0">
      <div class="border bg-custom-blue-2 rounded-xl p-4 md:p-5 shadow-2xl pr-4 md:pr-6 w-full md:w-auto mb-4 md:mb-0">
        <img src="/public/shield-icon.png" alt="" class="w-16 md:w-[80px] h-auto md:h-[80px]">

        <h1 class="font-bold text-xl md:text-3xl pt-4 md:pt-10">Bizwiz ERP</h1>
        <p class="pt-4 md:pt-10 text-sm md:text-[18px] font-light">
        ...
        <button class="mt-8 md:mt-16 border rounded-full bg-white/20 border-white/30 p-2 md:p-[10px] flex hover:bg-custom-blue">Learn more <span class="ml-20 md:ml-56"><CircleChevronRight /></span></button>
      </div>

      <div class="border bg-custom-blue-2 rounded-xl shadow-2xl p-4 md:p-5 pr-4 md:pr-6 w-full md:w-auto mb-4 md:mb-0">
        <img src="/public/shield-icon.png" alt="" class="w-16 md:w-[80px] h-auto md:h-[80px]">
        <h1 class="font-bold text-xl md:text-3xl pt-4 md:pt-10">Bizwiz POS</h1>
        <p class="pt-4 md:pt-10 text-sm md:text-[18px] font-light">
        ...
        <button class="mt-8 md:mt-16 border rounded-full bg-white/20 border-white/30 p-2 flex hover:bg-custom-blue">Learn more <span class="ml-20 md:ml-56"><CircleChevronRight /></span></button>      </div>

      <div class="border bg-custom-blue-2 rounded-xl p-4 md:p-5 pr-4 md:pr-6 shadow-2xl w-full md:w-auto mb-4 md:mb-0">
        <img src="/public/shield-icon.png" alt="" class="w-16 md:w-[80px] h-auto md:h-[80px] ">
        <h1 class="font-bold text-xl md:text-3xl pt-4 md:pt-10">Bizwiz Supplier Portal</h1>
        <p class="pt-4 md:pt-10 text-sm md:text-[18px] font-light">
      ...
      <div class="border bg-custom-blue-2 rounded-xl p-4 md:p-5 pr-4 md:pr-6 shadow-2xl w-full md:w-auto mb-4 md:mb-0">
        <img src="/public/shield-icon.png" alt="" class="w-16 md:w-[80px] h-auto md:h-[80px] ">
        <h1 class="font-bold text-xl md:text-3xl pt-4 md:pt-10">Bizwiz Order-taking <br/>Deivery App</h1>
        <p class="pt-2 md:pt-6 text-sm md:text-[18px] font-light">
        ...
        <button class="mt-2 md:mt-6 border rounded-full bg-white/20 border-white/30 p-2 flex hover:bg-custom-blue">Learn more <span class="ml-20 md:ml-56"><CircleChevronRight /></span></button>      </div>
    </div>
...
<!-- Third section -->
  ...
  <article>
    ...
    <main>
      <div class="flex flex-wrap justify-center items-center mr-0 md:mr-36 ">
        <div class=" flex justify-center items-center relative pt-8 w-full md:w-auto">
          ...
          <img src="/public/phone.png" alt="black phone" class="w-full max-w-[840px] h-auto object-contain">
        </div>
        <div class="mt-20 w-full md:w-auto px-4 md:px-0">

          <h2 class="text-xl md:text-2xl font-bold">Our product</h2>
          <h1 class="text-3xl md:text-6xl font-extrabold text-custom-blue-2 mt-4 md:mt-12">Bizwiz Features</h1>

          <p class="text-lg md:text-3xl pt-4 md:pt-12 pb-4 md:pb-10 leading-relaxed md:leading-[44px]">With <strong> Bizwiz</strong>, you'll benefit from a one-<br/>stop commerce platform that gives <br/>you innovative tools that will improve<br/> your bsiness management.Below<br/> are some benefits:</p>
          <a href="#" class="text-custom-blue text-sm md:text-[18px] p-2 font-semibold flex hover:border-b-4 hover:border-l-4 hover:shadow hover:rounded-full hover: transition">learn more about POS hardware <span class=" ml-10 md:ml-40"><CircleChevronRight /></span></a>
    ...
    <main>
      <div>
        <img src="/src/assets/business-structure.png" alt="" class="mx-auto md:ml-[265px]  h-auto w-full md:w-[72%] m-6 mt-12 mb-10">
      </div>

      <div class="text-center px-4 md:px-0">
        <h1 class="font-bold text-xl md:text-[24px] ">Sales & Distribution</h1>
      <p class="text-lg md:text-3xl mt-4 md:mt-10 tracking-wide leading-relaxed md:leading-[44px]">
...
<!-- Forth section -->
  ...
  <section class="bg-purple bg-cover bg-center text-white flex flex-wrap justify-center items-center mt-20 md:mt-80 rounded-3xl mx-4 md:mx-40 p-2">
    <div class="w-full md:w-auto">
      <img src="/src/assets/woman-in-blue.png" alt="woman" class="h-auto max-h-[600px] w-full md:w-[800px]">
    </div>

    <div class="w-full md:w-auto px-4 md:px-0">
      <p class="font-bold text-3xl md:text-7xl tracking-tight" >Let us be part of<br/> your growth journey.</p>
      <p class="text-base md:text-[26px] leading-[1.4] mt-4 md:mt-12">
      ...
      <button class="bg-yellow-300 rounded-full p-3 md:p-5 mt-4 md:mt-10 px-6 md:px-14 text-black font-bold text-base md:text-xl hover:bg-yellow-500">Book a Demo</button>
    </div>
